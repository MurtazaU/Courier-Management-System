...
if(isset($_REQUEST['courier-submit'])){
  ...
  // Inserting Data
  $sql = $con -> prepare("update package set PackageSenderId = ?, PackageReceiverName = ?, PackageReceiverNumber = ?, PackageFromAddress = ?, PackageToAddress = ?, PackageReceiverZipCode = ?, PackageReceiverCity = ?, PackageReceiverCountry = ?, PackageWeightId = ?, PackageProductTypeId = ?, PackageAgentId = ?, PackageDeliveryServiceId = ? where PackageId = ?");
  ...
  $sql -> bindParam(11,$agentId);
  $sql -> bindParam(12,$deliveryService);
  $sql -> bindParam(13,$courierId);

  $sql->execute();
  ?>
  <script>window.location.href = "./courier.php";
</script>
  <?php
}
               ...
               <select name="courier-agent-email" id=" courier-agent-email" class=" search-select form-select" >
                  ...
                  foreach($agentRecord as $row){
                    if($row->AgentId == $data->PackageAgentId){
                        ?>
                    <option selected value="<?php echo $data->PackageAgentId ?>"><?php echo $row->AgentEmail ?></option>
                    <?php
                    }else{
?>
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input
                         ...
                         value="<?php echo $data->PackageFromAddress ?>"
                         />
                </div>
              </div>
              ...
              <div class="col-md-6">
                <label for="courier-receiver-address" class="form-label"
                  ...
                  <input
                        ...
                        value="<?php echo $data->PackageToAddress ?>"
                        />
                </div>
                ...
                <label for="courier-receiver-zip-code" class="form-label"
                  ...
                  <input
                        ...
                        value="<?php echo $data->PackageReceiverZipCode ?>"
                        />
                </div>
                <div class="row">
